...
public class ProfileActivity extends AppCompatActivity {
    ...
    private TextView name, gender, dob, nid, bloodgroup, homeaddress, postalcode, phonenumber, email;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
              if (snapshot.exists()){
                  ...
                  dob.setText(snapshot.child("dateofbirth").getValue().toString());
                  nid.setText(snapshot.child("nid").getValue().toString());
                  bloodgroup.setText(snapshot.child("bloodgroup").getValue().toString());
                  homeaddress.setText(snapshot.child("homeaddress").getValue().toString());
                  postalcode.setText(snapshot.child("postalcode").getValue().toString());
